...
class PurgeLeoMessageLogsCommandTest extends TestCase
{
    ...
    {
        LeoMessageLog::factory()->create(['created_at' => now()->subDays(91)]);
        LeoMessageLog::factory()->create(['created_at' => now()->subDays(10)]);
    ...
    {
        LeoMessageLog::factory()->create(['created_at' => now()->subDays(8)]);
        LeoMessageLog::factory()->create(['created_at' => now()->subDays(4)]);
