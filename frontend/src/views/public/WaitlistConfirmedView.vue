...
<template>
  ...
  >
    <div class="max-w-md w-full space-y-8 text-center">
      <div
        class="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl border border-green-100 dark:border-green-900/30"
      >
        <div
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-500">À très bientôt !</p>
      </div>
    </div>
  </div>
</template>
