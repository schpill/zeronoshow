  ...
  <article class="prose max-w-none">
    ...
    <section class="mt-8">
      ...
      <p class="text-body-sm mt-3 dark:text-slate-400">
        Le score est calculé à partir de l'historique du client <strong>à travers tous les établissements</strong>
        de la plateforme ZeroNoShow. Plus le nombre de réservations est élevé, plus le score est fiable.
      </p>
    ...
    <section class="mt-8">
      ...
      <div class="mt-6 grid gap-4 sm:grid-cols-3">
        <div class="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-800 dark:bg-emerald-900/20">
          <span class="inline-block rounded-full bg-emerald-100 px-2.5 py-1 text-xs font-bold text-emerald-900 dark:bg-emerald-900/40 dark:text-emerald-300">Fiable ≥90%</span>
        ...
        <div class="rounded-2xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
          <span class="inline-block rounded-full bg-amber-100 px-2.5 py-1 text-xs font-bold text-amber-800 dark:bg-amber-900/20 dark:text-amber-300">Moyen 70-89%</span>
          <p class="mt-2 text-sm text-slate-700 dark:text-slate-300">
        ...
        <div class="rounded-2xl border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20">
          <span class="inline-block rounded-full bg-red-100 px-2.5 py-1 text-xs font-bold text-red-800 dark:bg-red-900/20 dark:text-red-300">À risque &lt;70%</span>
          <p class="mt-2 text-sm text-slate-700 dark:text-slate-300">
    ...
    <section class="mt-8">
      ...
      <p class="text-body-sm mt-3 dark:text-slate-400">
        Si le client n'a jamais été vu sur la plateforme (score null), il est traité comme "À risque"
        par précaution.
      </p>
    </section>
  </article>
