...
const statusClasses = computed(() => {
  return {
    ...
    'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400': props.status === 'notified',
    'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400': props.status === 'confirmed',
...
<template>
  <div class="flex flex-col items-center">
    ...
    <span v-if="countdown" class="text-[10px] mt-0.5 font-mono text-yellow-600 dark:text-yellow-400">
      {{ countdown }}
    </span>
  </div>
</template>
