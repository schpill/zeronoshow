...
vi.mock('@/composables/useReservations', () => ({
  useReservations: () => ({
    fetchReservation: vi.fn().mockResolvedValue({
      ...
      customer: { phone: '+33612345678', reliability_score: 90, score_tier: 'reliable', reservations_count: 2, shows_count: 2, no_shows_count: 0 },
      sms_logs: [{ id: 'sms-1', type: 'reminder', status: 'delivered', phone: '+33612345678', body: 'Bonjour', cost_eur: 0.12 }],
    }),
  }),
}))
